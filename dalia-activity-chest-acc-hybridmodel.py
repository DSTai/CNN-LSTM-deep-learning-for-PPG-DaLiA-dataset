...
def create_segments_and_labels(df, time_steps, step):
    ...
    for i in range(0, len(df) - time_steps, step):
        ...
        #print(stats.mode(df['label'][i: i + time_steps]))
...
WEIGHTS_PATH = "D:/Documents/Downloads/Human_Activity_Recognition/weights/dalia-activity-chest-acc-hybrid/"
...
#write_list_to_file(act_list_actual_train,'semantic_concept_generation/activity_actual_train.csv')
    ...
    report_file_path = os.path.join(report_dir,f"{report_dir}/HYBRID_Chest_batch_size{BATCH_SIZE}.txt")
