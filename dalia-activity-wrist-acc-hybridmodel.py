...
WEIGHTS_PATH = "D:/Documents/Downloads/Human_Activity_Recognition/weights/dalia-activity-wrist-acc-hybrid/"
...
#write_list_to_file(act_list_actual_train,'semantic_concept_generation/activity_actual_train.csv')
    ...
    report_file_path = os.path.join(report_dir,f"{report_dir}/HYBRID_Wrist_batch_size{BATCH_SIZE}.txt")
