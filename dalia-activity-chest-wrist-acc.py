...
def read_data(cwd, filepath):
    ...
    #cols_to_norm = ['CHEST-ACC-X',
    #                'CHEST-ACC-Y',
    #                'CHEST-ACC-Z',
    #                'WRIST-ACC-X',
    #                'WRIST-ACC-Y',
    #                'WRIST-ACC-Z']
    #df_frames[cols_to_norm] = df[cols_to_norm].apply(lambda x: (x - x.mean()) / (x.max() - x.min()))
    # Round numbers
...
WEIGHTS_PATH = "D:/Documents/Downloads/Human_Activity_Recognition/weights/dalia-activity-chest-wrist-acc-lstm/"
...
for epoch_count in EPOCHS:
    ...
    report_file_path = os.path.join(report_dir,f"{report_dir}/LSTM_Chest_wrist_batch_size{BATCH_SIZE}.txt")
